...
def Get_NormalizedAverageWageDataset():
    dfw = pd.read_csv(path.join(r'C:\Users\ronsa\Source\Repos\Final-Project---Ron-Sanderovich\DemoFormProject\static\Data\AverageWage.csv'))
...
def Convert_StateCode_ToFullName(df): #doesnt work for some reason i spent 3 hours trying to figure out
    df_short_state = pd.read_csv(r"C:\Users\ronsa\Source\Repos\Final-Project---Ron-Sanderovich\DemoFormProject\static\Data\countries_codes_and_coordinates.csv")
